...
\maketitle
\begin{abstract}
	We present an approach to integrate price forecasts into an energy scheduling problem.
...
We have introduced an approach that closely integrates the learning and scheduling phases in solving an energy-aware scheduling problem. Instead of approximating the actual price of each day, our approach directly minimizes the total cost of the resulting schedules. Our experiments show that this is approach is not really advantegeous over simple linear regression.
